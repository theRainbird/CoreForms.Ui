...
public class DataGridPage : UserControl
{
    ...
    public DataGridPage()
    {
        ...
        dataGrid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
            { HeaderText = SR.GetString("ColId"), Width = 60, Name = "Id", DataPropertyName = "Id",
              TextAlign = OldSchoolForms.Ui.Controls.Advanced.DataGridViewContentAlignment.Right, FormatString = "D3",
        ...
        dataGrid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
            { HeaderText = SR.GetString("ColStatus"), Width = 100, Name = "Status", DataPropertyName = "Status",
              TextAlign = OldSchoolForms.Ui.Controls.Advanced.DataGridViewContentAlignment.Center,
        ...
        dataGrid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
            { HeaderText = SR.GetString("ColSalary"), Width = 110, Name = "Salary", DataPropertyName = "Salary",
              TextAlign = OldSchoolForms.Ui.Controls.Advanced.DataGridViewContentAlignment.Right, FormatString = "C",
              CellEditType = DataGridViewColumnEditType.TextBox });
        dataGrid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
        ...
        dataGrid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
            { HeaderText = "", Width = 70, Name = "Actions",
              ...
              ButtonIcon = OldSchoolForms.Ui.Resources.Icons.Edit16 });
