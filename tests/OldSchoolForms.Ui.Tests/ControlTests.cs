...
[Fact]
    ...
    {
        var panel = new OldSchoolForms.Ui.Controls.Containers.Panel();
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1" });
        grid.AddRow("A1");
        grid.AddRow("A2");
        grid.AddRow("A3");
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        var col = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1", CellEditType = DataGridViewColumnEditType.TextBox };
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        var col = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
        {
            HeaderText = "Col1",
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        var col = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1", CellEditType = DataGridViewColumnEditType.None };
        grid.Columns.Add(col);
        grid.AddRow("A1");
    ...
    public void DataGridView_DemoConfig_EditableCellClick_StartsEditing()
    {
        ...
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1", CellEditType = DataGridViewColumnEditType.TextBox });
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col2", CellEditType = DataGridViewColumnEditType.TextBox });
        grid.AddRow("A1", "B1");
        grid.AddRow("A2", "B2");
        grid.SelectedRowIndex = 0;
        grid.SelectedColumnIndex = 0;
    ...
    public void DataGridView_TabNavigationAtLastColumn_MovesToNextRow()
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1" });
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col2" });
        grid.AddRow("A1", "B1");
        grid.AddRow("A2", "B2");
        grid.SelectedRowIndex = 0;
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        var col1 = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1", CellEditType = DataGridViewColumnEditType.TextBox };
        var col2 = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col2", CellEditType = DataGridViewColumnEditType.TextBox };
    ...
    {
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        var col1 = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col1", CellEditType = DataGridViewColumnEditType.TextBox, ReadOnly = true };
        var col2 = new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Col2", CellEditType = DataGridViewColumnEditType.TextBox };
        grid.Columns.Add(col1);
        grid.Columns.Add(col2);
    ...
    {
        var tabControl = new OldSchoolForms.Ui.Controls.Advanced.TabControl();
        tabControl.TabPages.Add(new OldSchoolForms.Ui.Controls.Advanced.TabPage { Text = "Tab1" });
        tabControl.TabPages.Add(new OldSchoolForms.Ui.Controls.Advanced.TabPage { Text = "Tab2" });
...
[Fact]
    ...
    {
        var outerPanel = new OldSchoolForms.Ui.Controls.Containers.Panel();
        outerPanel.Size = new Size(400, 400);
        var innerPanel = new OldSchoolForms.Ui.Controls.Containers.Panel();
...
[Fact]
    ...
    public void DataGridView_UngroupedInsideTabControl_SelectsCorrectRow()
    {
        ...
        var tabPage = new OldSchoolForms.Ui.Controls.Advanced.TabPage();
        var grid = new OldSchoolForms.Ui.Controls.Advanced.DataGridView();
        grid.Dock = DockStyle.Fill;
        grid.ColumnHeadersVisible = true;
        grid.AllowUserToAddRows = false;
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Name", Width = 150 });
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Value", Width = 120 });
        for (int i = 0; i < 12; i++)
    ...
    {
        var container = new OldSchoolForms.Ui.Controls.Containers.Panel();
        ...
        tabPage.Controls.Add(grid);
        tabControl.AddTabPage(tabPage);
        tabControl.AddTabPage(new OldSchoolForms.Ui.Controls.Advanced.TabPage { Text = "Tab 2" });

        container.Controls.Add(tabControl);

        var buttonPanel = new OldSchoolForms.Ui.Controls.Containers.Panel { Dock = DockStyle.Bottom, Height = 50 };
    ...
    public void DataGridView_GroupedMode_MultiGroupHitTest_SelectsCorrectRow()
    {
        ...
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Category", Groupable = true });
        grid.Columns.Add(new OldSchoolForms.Ui.Controls.Advanced.DataGridViewColumn { HeaderText = "Type", Groupable = true });
        grid.AddRow("A", "X");
        grid.AddRow("A", "Y");
        grid.AddRow("B", "X");
        grid.AddRow("B", "Y");
