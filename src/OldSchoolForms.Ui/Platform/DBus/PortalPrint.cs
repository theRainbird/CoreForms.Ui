...
using OldSchoolForms.Ui.Printing;
...
internal static class PortalPrint
{
        ...
        out PageSettings? resultPageSettings)
    {
        ...
        string requestPath = $"/org/freedesktop/portal/desktop/request/OldSchoolForms/{token}";
        ...
        try
        {
            ...
            var reply = conn.SendAndWaitForReply(msg, timeoutMs: 10000,
                pumpEvents: () => OldSchoolForms.Ui.Platform.Platform.ProcessEvents(Application.Instance));
    ...
    public static string GetParentHandleString(Form? form)
    {
        ...
        nint nativeHandle = OldSchoolForms.Ui.Platform.Platform.GetNativeWindowHandle(form);
