...
public class Form : ContainerControl, INativeWindow
{
    ...
    public void Show()
    {
        ...
        if (!_zoomSet)
        {
            var activeForm = OldSchoolForms.Ui.Platform.Platform.FocusedWindow;
    ...
    public override void Render(OldSchoolForms.Ui.Rendering.Graphics g)
    {
    ...
    protected internal override void OnMouseDown(EventArgs e)
    {
        ...
        {
            var controlOrigin = _captureControl.GetFormRelativePosition();
            var localPoint = new Point(args.X - controlOrigin.X, args.Y - controlOrigin.Y);
